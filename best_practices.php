...
<p>If you have any specific questions about API key and access token security, please don't hesitate to contact us at api@vc4africa.biz.</p>
<!--h4>Authenticating End Users With OAuth 2</h4>
<p>If you are shortening URLs on behalf of end-users, we ask that you use our OAuth 2 implementation to authenticate end-users before shortening. URLs shortened in this manner will be added to the specified end-user’s history, allowing the end-user to manage and track his/her shortened URLs. To register an OAuth application, please contact api@VC4A.com.</p-->
...
<p>If you need to make a large number of requests to the VC4A API, we recommend that you leave ample time to spread these requests out over many hours. To inquire about a high-volume VC4A Enterprise license, please contact enterprisehelp@vc4africa.biz.</p>
