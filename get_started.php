...
<p>Check out some of our <a href="libraries.php">libraries and tools</a> for interacting with the VC4A API via a number of popular programming languages, or proceed to the <a href="api.php">API documentation</a> directly.</p>
